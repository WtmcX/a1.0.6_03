...
public class GuiMainMenu extends GuiScreen {
	...
	public void initGui() {
		...
		if(this.mc.session.username.equals("athna") && var1.get(2) + 1 == 7 && var1.get(5) == 26 && var1.get(1) == 2010) {
			this.currentSplash = "Happy birthday! I love you! Alex x";
		} else if(var1.get(2) + 1 == 11 && var1.get(5) == 9) {
			this.currentSplash = "Happy birthday, ez!";
		} else if(var1.get(2) + 1 == 6 && var1.get(5) == 1) {
			this.currentSplash = "Happy birthday, Notch!";
		} else if(var1.get(2) + 1 == 12 && var1.get(5) == 24) {
			this.currentSplash = "Merry X-mas!";
		} else if(var1.get(2) + 1 == 1 && var1.get(5) == 1) {
			this.currentSplash = "Happy new year!";
		}
